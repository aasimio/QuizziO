...
- [ ] **0.1 Project Dependencies**
  - [ ] 0.1.1 Update `pubspec.yaml` with all dependencies from Tech Stack
  - [ ] 0.1.2 `flutter pub get` and verify no conflicts
  - [ ] 0.1.3 Update `AndroidManifest.xml`: `minSdkVersion 24`, camera/storage permissions
  - [ ] 0.1.4 Update `Info.plist`: camera/photo permissions
